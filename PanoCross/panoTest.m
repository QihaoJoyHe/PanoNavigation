...
global snapshot feedback Triggerkey Esckey slack fov centeredRect black white red compassRadius compassX compassY pointerLength pointerWidth

% Test phase: Display scene snapshot
% exclude overlap
testFrameIdx = randi([46,315]);  
imgPath = sprintf('video/p%d_%d.jpg', panoNum, testFrameIdx + align);
img = imread(imgPath);
