...
for p = 1:panoNum
    ...
    if angle1 <= angle4  % north: road1
        ...
        IrrPano(p).cr1 = 0;
        IrrPano(p).cr2 = IrrParameters.RoadRotation2_N(p) - IrrParameters.RoadRotation1_N(p);
        IrrPano(p).cr3 = IrrParameters.RoadRotation3_N(p) - IrrParameters.RoadRotation1_N(p);
        IrrPano(p).cr4 = IrrParameters.RoadRotation4_N(p) - IrrParameters.RoadRotation1_N(p);
    else  % north: road4
        ...
        % Record centered road rotations
        IrrPano(p).cr1 = 0;
        IrrPano(p).cr2 = IrrParameters.RoadRotation1_N(p) + 360 - IrrParameters.RoadRotation4_N(p);
        IrrPano(p).cr3 = IrrParameters.RoadRotation2_N(p) + 360 - IrrParameters.RoadRotation4_N(p);
        IrrPano(p).cr4 = IrrParameters.RoadRotation3_N(p) + 360 - IrrParameters.RoadRotation4_N(p);
    end
    % align range
